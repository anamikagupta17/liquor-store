      ...
      <div className="container">
        <div className="row no-gutters slider-text align-items-end justify-content-center">
          <div className="col-md-9 ftco-animate mb-5 text-center">
          	<p className="breadcrumbs mb-0"><span className="mr-2"><a href="index.html">Home <i className="fa fa-chevron-right"></i></a></span> <span>Blog Detail  <i className="fa fa-chevron-right"></i></span></p>
            <h2 className="mb-0 bread">Blog Detail </h2>
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="row">
          <div className="col-lg-8 ftco-animate">
            ...
            <div className="about-author d-flex p-4 bg-light">
              <div className="bio mr-5">
                <img src={person1} alt="Image placeholder" className="img-fluid mb-4"/>
              </div>
              <div className="desc">
          ...
          <div className="col-lg-4 sidebar pl-lg-5 ftco-animate">
            ...
            <div className="sidebar-box ftco-animate">
              ...
              <div className="block-21 mb-4 d-flex">
                <a className="blog-img mr-4" style={{ backgroundImage: `url(${image2})` }}></a>
                <div className="text">
                  <h3 className="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div className="meta">
                    <div><a href="#"><span className="fa fa-calendar"></span> Apr. 18, 2020</a></div>
              ...
              <div className="block-21 mb-4 d-flex">
                <a className="blog-img mr-4" style={{ backgroundImage: `url(${image3})` }}></a>
                <div className="text">
                  <h3 className="heading"><a href="#">Even the all-powerful Pointing has no control about the blind texts</a></h3>
                  <div className="meta">
                    <div><a href="#"><span className="fa fa-calendar"></span> Apr. 18, 2020</a></div>
